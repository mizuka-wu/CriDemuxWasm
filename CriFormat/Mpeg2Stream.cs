...
namespace VGMToolbox.format
{
    public class Mpeg2Stream : MpegStream
    {
            ...
            base(path)
        {
            ...
            BlockIdDictionary[BitConverter.ToUInt32(PacketStartBytes, 0)] =
                new BlockSizeStruct(PacketSizeType.Static, 0xE); // Pack Header
        }
        ...
        protected ulong DecodePresentationTimeStamp(byte[] EncodedTimeStampBytes)
        {
            ...
            if (EncodedTimeStampBytes.Length != 5) throw new FormatException("Encoded time stamp must be 5 bytes.");
            ...
            decodedTimeStamp |=
                (encodedTimeStamp >> 3) & (0x0007ul << 30); // top 3 bits, shifted left by 3, other bits zeroed out
